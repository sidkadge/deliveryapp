...
<html lang="en">
   ...
   <body>
      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="logo"><a href="index.html"><img  src="<?php  echo base_url(); ?>public/assets1/images/logo.png"></a></div>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link"  href="<?php  echo base_url(); ?>public/assets1/contact.html">Contact Us</a>
                     </li>
                  </ul>
                  <form class="form-inline my-2 my-lg-0">
                     <div class="login_text"><a href="#">Login</a></div>
                     <div class="search_icon"><a href="#"><img  src="<?php  echo base_url(); ?>public/assets1/images/search-icon.png"></a></div>
                  </form>
               </div>
            </nav>
         </div>
      ...
      <div class="container">
         <div class="play_icon"><a href="#"><img  src="<?php  echo base_url(); ?>public/assets1/images/play-icon.png"></a></div>
      </div>
      <!--header section end -->
            ...
            <div class="language_section_2 layout_padding">
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main">
                        <div class="icon_1"><img  src="<?php  echo base_url(); ?>public/assets1/images/icon-1.png"></div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main active">
                        <div class="icon_1"><img  src="<?php  echo base_url(); ?>public/assets1/images/icon-2.png"></div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main">
                        <div class="icon_1"><img  src="<?php  echo base_url(); ?>public/assets1/images/icon-3.png"></div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main">
                        <div class="icon_1"><img  src="<?php  echo base_url(); ?>public/assets1/images/icon-4.png"></div>
      ...
      <div class="services_section layout_padding">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="image_1"><img  src="<?php  echo base_url(); ?>public/assets1/images/img-1.png"></div>
                  <div class="image_2"><img  src="<?php  echo base_url(); ?>public/assets1/images/img-2.png"></div>
               </div>
            </div>
         </div>
      </div>
                     ...
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-lg-4 col-md-6">
                              <div class="image_3">
                                 <div class="play_icon_2"><a href="#"><img  src="<?php  echo base_url(); ?>public/assets1/images/play-icon-2.png"></a></div>
         ...
         <div class="container">
            ...
            <div class="about_section_2">
               <div class="row">
                  <div class="col-md-6">
                     <div class="image_6">
                        <div class="play_icon_3"><a href="#"><img  src="<?php  echo base_url(); ?>public/assets1/images/play-icon-2.png"></a></div>
                     </div>
                  </div>
                  <div class="col-md-6">
      ...
      <div class="courses_section layout_padding">
         <div class="container">
            ...
            <div class="courses_section_2">
               <div class="flag_main">
                  <div class="flag_text"><img  src="<?php  echo base_url(); ?>public/assets1/images/flag-1.png"><span class="padding_left_15">Chinese</span></div>
                  <hr class="border_bg">
                  <h6 class="learn_text active">Language start learn</h6>
               </div>
               <div class="flag_main">
                  <div class="flag_text"><img  src="<?php  echo base_url(); ?>public/assets1/images/flag-2.png"><span class="padding_left_15">English</span></div>
                  <hr class="border_bg">
                  <h6 class="learn_text">Language start learn</h6>
               </div>
               <div class="flag_main">
                  <div class="flag_text"><img  src="<?php  echo base_url(); ?>public/assets1/images/flag-3.png"><span class="padding_left_15">French</span></div>
                  <hr class="border_bg">
                  <h6 class="learn_text">Language start learn</h6>
               </div>
               <div class="flag_main">
                  <div class="flag_text"><img  src="<?php  echo base_url(); ?>public/assets1/images/flag-4.png"><span class="padding_left_15">German</span></div>
                  <hr class="border_bg">
                  <h6 class="learn_text">Language start learn</h6>
               </div>
               <div class="flag_main">
                  <div class="flag_text"><img  src="<?php  echo base_url(); ?>public/assets1/images/flag-5.png"><span class="padding_left_15">Japanese</span></div>
                  <hr class="border_bg">
                  <h6 class="learn_text">Language start learn</h6>
               </div>
               <div class="flag_main">
                  <div class="flag_text"><img  src="<?php  echo base_url(); ?>public/assets1/images/flag-6.png"><span class="padding_left_15">Spanish</span></div>
                  <hr class="border_bg">
                  <h6 class="learn_text">Language start learn</h6>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="images_main">
                        <img  src="<?php  echo base_url(); ?>public/assets1/images/img-7.png" class="image_7">
                     </div>
                  ...
                  <div class="col-md-6">
                     <div class="images_main">
                        <img  src="<?php  echo base_url(); ?>public/assets1/images/img-8.png" class="image_7">
                     </div>
                     <p class="lorem_text">It is a long established fact that a reader will be distracted by the readable content of a </p>
                     <div class="time_section">
                        <div class="live_text">Live event</div>
            ...
            <div class="students_section_2 layout_padding">
               <div class="client_main">
                  <div class="client_left">
                     <div class="image_9"><img  src="<?php  echo base_url(); ?>public/assets1/images/img-9.png"></div>
                  </div>
                  <div class="client_right">
                     ...
                     <div class="quote_icon"><img  src="<?php  echo base_url(); ?>public/assets1/images/quote-icon.png"></div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="container">
         <div class="newsletter_section layout_padding">
            ...
            <div class="mail_main">
               ...
               <div class="left_arrow"><a href="#"><img  src="<?php  echo base_url(); ?>public/assets1/images/left-arrow.png"></a></div>
            </div>
         </div>
      </div>
      ...
      <div class="footer_section">
         <div class="container">
            ...
            <div class="call_main">
               <div class="call_text"><img  src="<?php  echo base_url(); ?>public/assets1/images/call-icon.png"><span class="padding_left_15">Call Now  +01 123467890</span></div>
               <div class="call_text"><img  src="<?php  echo base_url(); ?>public/assets1/images/mail-icon.png"><span class="padding_left_15">demo@gmail.com</span></div>
            </div>
            <div class="social_icon">
               <ul>
                  <li><a href="#"><img  src="<?php  echo base_url(); ?>public/assets1/images/fb-icon.png"></a></li>
                  <li><a href="#"><img  src="<?php  echo base_url(); ?>public/assets1/images/twitter-icon.png"></a></li>
                  <li><a href="#"><img  src="<?php  echo base_url(); ?>public/assets1/images/linkedin-icon.png"></a></li>
                  <li><a href="#"><img  src="<?php  echo base_url(); ?>public/assets1/images/instagram-icon.png"></a></li>
               </ul>
            </div>
         </div>
      </div>
      ...
      <div class="copyright_section">
         <div class="container">
            <p class="copyright_text"> 2023 All Rights Reserved. Design by <a href="html.design">Free Html Templates</a></p>
         </div>
      </div>
