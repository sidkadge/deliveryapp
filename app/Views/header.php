      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="logo"><a href="<?php echo base_url() ?>"><img src="public/assets1/images/logo.png"></a></div>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <form class="form-inline my-2 my-lg-0">
                     <div class="login_text"><a href="<?php echo base_url() ?>login">Login</a></div>
                     <div class="search_icon"><a href="#"><img src="public/assets1/images/search-icon.png"></a></div>
                  </form>
               </div>
            </nav>
         </div>
